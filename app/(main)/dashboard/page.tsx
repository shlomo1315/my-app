      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
        <div className="bg-white rounded-xl border border-slate-200 p-5">
          ...
          <div className="grid grid-cols-2 gap-3">
            {[
              { href: '/beneficiaries/new', label: 'רישום נתמך חדש', icon: Users, color: 'bg-indigo-50 text-indigo-700 hover:bg-indigo-100' },
              { href: '/maternity/new', label: 'פתיחת תיק יולדת', icon: Baby, color: 'bg-pink-50 text-pink-700 hover:bg-pink-100' },
              { href: '/loans/new', label: 'בקשת הלוואה', icon: CreditCard, color: 'bg-blue-50 text-blue-700 hover:bg-blue-100' },
              { href: '/distributions/new', label: 'חלוקה חדשה', icon: Gift, color: 'bg-purple-50 text-purple-700 hover:bg-purple-100' },
